package net.tjtorrico.twitterclient.login.ui;
...
import net.tjtorrico.twitterclient.main.ui.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twitterLoginButton.setCallback(new Callback<TwitterSession>() {
            ...
            public void failure(TwitterException exception) {
                ...
                Snackbar.make(viewPager, msgError, Snackbar.LENGTH_SHORT).show();
            }
        });
    }
